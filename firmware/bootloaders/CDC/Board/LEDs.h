 ...
 *  \copydetails Group_LEDs_CIAODUINO
 *
...
/** \ingroup Group_LEDs
 *  \defgroup Group_LEDs_CIADUINO CIAODUINO
 *  \brief Board specific LED driver header for the Ciaoduino board.
 *
 *  <table>
...
#ifndef __LEDS_CIAODUINO_H__
#define __LEDS_CIAODUINO_H__
